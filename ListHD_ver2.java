...
public class ListHD {
    ...
    public boolean checkTrung(String nguoiMua, String nguoiHuongThu, int thoiHan, long giaTri, int ngay, int thang, int nam) {
        LocalDate ngayMua = LocalDate.of(nam, thang, ngay);
        for(HopDong tmp: list) {
            if((tmp.getTenNguoiMua()==nguoiMua) && (tmp.getTenNguoiThuHuong()==nguoiHuongThu) && (tmp.getThoiHanHD()==thoiHan) && (tmp.getGiaTriHD()==giaTri) && (tmp.getNgayMua()==ngayMua)) {
                return false;
            }
        }
        return true;
    ...
    public void themHopDong(){
        ...
        while(check){
            ...
            if( loaiHopDong==0 ){                
                ...
                if(checkTrung(nguoiMua, nguoiHuongThu, thoiHan, giaTri, ngay, thang, nam)) {
                    System.out.println(checkTrung(nguoiMua, nguoiHuongThu, thoiHan, giaTri, ngay, thang, nam));
                    list.add(tmp);
                    check = false;
                }
            }
